...
public interface GooglePlacesInterface extends Types, Statuses {
     ...
     * {@link NeededFiles.se.walkercrou.places.exception.GooglePlacesException} will be thrown.
     *
     * @param lat    latitude
     * @param lng    longitude
     * @param limit  the maximum amount of places to return
     ...
     * @throws NeededFiles.se.walkercrou.places.exception.GooglePlacesException if 'keyword', 'name' or 'types' is not included.
     */
